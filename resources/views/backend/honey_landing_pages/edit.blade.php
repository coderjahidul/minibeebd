        ...
        <div class="vertical-tabs-container">
          ...
          <div class="tab-nav">
            <ul class="nav nav-pills flex-column" id="v-tabs" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="pill" href="#video" role="tab">Video Section</a>
              </li>
              <li class="nav-item">
          ...
          <div class="tab-content-area">
            <div class="tab-content" id="v-tabsContent">
              ...
              <div class="tab-pane fade" id="video" role="tabpanel">
                <div class="form-section">
                  <h5 class="mb-4">Video Section</h5>
                  <form id="ajax_form" action="{{ route('admin.honey_landing_pages.update_section', $page->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="content[video][heading]" class="form-control"
                             value="{{ $page->content['video']['heading'] ?? '' }}" placeholder="e.g. আমাদের মধু সংগ্রহের দৃশ্য">
                    </div>

                    <div class="mb-3">
                      <label class="form-label">YouTube / Embed URL</label>
                      <input type="url" name="content[video][video_url]" class="form-control"
                             value="{{ $page->content['video']['video_url'] ?? '' }}" placeholder="https://www.youtube.com/watch?v=...">
                      <div class="form-text">Paste a YouTube watch link or any iframe embed URL. If both a URL and a file are provided, the URL takes priority.</div>
                    </div>

                    <div class="mb-3">
                      <label class="form-label">Upload Video File <span class="text-muted">(MP4 recommended)</span></label>
                      <input type="hidden" name="content[video][video_file]" value="{{ $page->content['video']['video_file'] ?? '' }}">
                      <input type="file" name="video_file" class="form-control" accept="video/*">
                      @if(isset($page->content['video']['video_file']) && $page->content['video']['video_file'])
                        <div class="mt-2">
                          <small class="text-muted">Current file:</small>
                          <video controls class="mt-1 rounded" style="max-width: 320px; max-height: 180px; display:block;">
                            <source src="{{ asset($page->content['video']['video_file']) }}" type="video/mp4">
                          </video>
                          <small class="text-muted">{{ $page->content['video']['video_file'] }}</small>
                        </div>
                      @endif
                    </div>

                    <button type="submit" class="btn btn-primary">Save Video Section</button>
                  </form>
                </div>
              </div>

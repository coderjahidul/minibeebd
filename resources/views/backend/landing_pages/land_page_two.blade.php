    ...
    <!--     </div>-->
                  ...
                  <div class="element-widget overview" style="margin-top: 0px;color: black;">
                      <div class="top_section" style="
                        ...
                        padding: 15px;text-align: center;">
                          ...
                          <img src="{{ asset('landing_pages/'.$ln_pg->landing_bg) }}" class="top_section_img" style="width: 90%;height: auto;" alt="img">
                          <h2 class="top-heading-title" style="color: #fff;
                                margin-top: 0px;
                                text-align: center;
                                padding: 20px 0px;
                                background: #ff730b;
         ...
         <div class="down-div">
            <div class="container">
               ...
               <div class="elementor-widget-wrap elementor-element-populated">
                      <div class="top_section" style="background: #ff730b;
                        background: #ff730b;
                        width: 100%;
                        border-radius: 10px;
                        color: #ffffff; 
                                        ...
                                        <div id="order_review" class="review-order">
                                            ...
                                            <div id="payment" class="checkout-payment">
                                                <ul class="payment_methods payment_methods methods">
                                                  ...
                                                  <p style="color: #FF730A;">{{ BanglaText('alert') }}</p>
                                                <div class="form-row place-order">
                                                     <button type="submit" class="button" form="checkout_land_form">{{ BanglaText('confirm_order') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
